...
void TrinamicGPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(DRV0_SPI_NSS_Port, DRV0_SPI_NSS_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV1_SPI_NSS_Port, DRV1_SPI_NSS_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV2_SPI_NSS_Port, DRV2_SPI_NSS_Pin, GPIO_PIN_SET);

	/* Configure GPIO pin : DRV0_SPI_NSS_Pin */
	GPIO_InitStruct.Pin   = DRV0_SPI_NSS_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV0_SPI_NSS_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV1_SPI_NSS_Pin */
	GPIO_InitStruct.Pin   = DRV1_SPI_NSS_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV1_SPI_NSS_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV2_SPI_NSS_Pin */
	GPIO_InitStruct.Pin   = DRV2_SPI_NSS_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV2_SPI_NSS_Port, &GPIO_InitStruct);

	HAL_GPIO_WritePin(DRV0_DIR_Port, DRV0_DIR_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV1_DIR_Port, DRV1_DIR_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV2_DIR_Port, DRV2_DIR_Pin, GPIO_PIN_SET);

	/* Configure GPIO pin : DRV0_DIR_Pin */
	GPIO_InitStruct.Pin   = DRV0_DIR_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV0_DIR_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV1_DIR_Pin */
	GPIO_InitStruct.Pin   = DRV1_DIR_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV1_DIR_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV2_DIR_Pin */
	GPIO_InitStruct.Pin   = DRV2_DIR_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV2_DIR_Port, &GPIO_InitStruct);

	/* Disable the Driver */
	HAL_GPIO_WritePin(DRV0_EN_Port, DRV0_EN_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV1_EN_Port, DRV1_EN_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(DRV2_EN_Port, DRV2_EN_Pin, GPIO_PIN_SET);

	/* Configure GPIO pin : DRV0_EN_Pin */
	GPIO_InitStruct.Pin   = DRV0_EN_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV0_EN_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV1_EN_Pin */
	GPIO_InitStruct.Pin   = DRV1_EN_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV1_EN_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV2_EN_Pin */
	GPIO_InitStruct.Pin   = DRV2_EN_Pin;
	GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP ;
	GPIO_InitStruct.Pull  = GPIO_PULLDOWN;
	HAL_GPIO_Init(DRV2_EN_Port, &GPIO_InitStruct);
	...
	HAL_GPIO_Init(DRV0_DIAGNOSTIC_Port, &GPIO_InitStruct);

	/* Configure GPIO pins : DRV1_DIAGNOSTIC_Pin */
	GPIO_InitStruct.Pin   = DRV0_DIAGNOSTIC_Pin;
	GPIO_InitStruct.Mode  = DIAG_PIN_INPUT_TYPE;
	GPIO_InitStruct.Pull  = GPIO_NOPULL;
	HAL_GPIO_Init(DRV1_DIAGNOSTIC_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : DRV2_DIAGNOSTIC_Pin */
	GPIO_InitStruct.Pin   = DRV0_DIAGNOSTIC_Pin;
	GPIO_InitStruct.Mode  = DIAG_PIN_INPUT_TYPE;
	GPIO_InitStruct.Pull  = GPIO_NOPULL;
	HAL_GPIO_Init(DRV2_DIAGNOSTIC_Port, &GPIO_InitStruct);

	/* Configure GPIO pin : GPIO0_NWAKE_Pin */
#ifdef NWAKE0_MOD_PUSHPULL
	HAL_GPIO_WritePin(GPIO0_NWAKE_Port, GPIO0_NWAKE_Pin, GPIO_PIN_RESET);
...
void TrinamicNSS_Select(uint8_t driver)
{
	...
	{
		HAL_GPIO_WritePin(DRV0_SPI_NSS_Port, DRV0_SPI_NSS_Pin, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(DRV1_SPI_NSS_Port, DRV1_SPI_NSS_Pin, GPIO_PIN_SET);
		HAL_GPIO_WritePin(DRV2_SPI_NSS_Port, DRV2_SPI_NSS_Pin, GPIO_PIN_SET);
	}
	...
	{
		HAL_GPIO_WritePin(DRV0_SPI_NSS_Port, DRV0_SPI_NSS_Pin, GPIO_PIN_SET);
		HAL_GPIO_WritePin(DRV1_SPI_NSS_Port, DRV1_SPI_NSS_Pin, GPIO_PIN_RESET);
		HAL_GPIO_WritePin(DRV2_SPI_NSS_Port, DRV2_SPI_NSS_Pin, GPIO_PIN_SET);
	}
	else if (driver == TRINAMIC_MOT2_ID)
	{
		HAL_GPIO_WritePin(DRV0_SPI_NSS_Port, DRV0_SPI_NSS_Pin, GPIO_PIN_SET);
		HAL_GPIO_WritePin(DRV1_SPI_NSS_Port, DRV1_SPI_NSS_Pin, GPIO_PIN_SET);
		HAL_GPIO_WritePin(DRV2_SPI_NSS_Port, DRV2_SPI_NSS_Pin, GPIO_PIN_RESET);
	}
	else
	{
		;
...
void TrinamicMotXEnable(uint8_t driver)
{
	...
	if (driver == TRINAMIC_MOT0_ID)
	{
		HAL_GPIO_WritePin(DRV0_EN_Port, DRV0_EN_Pin, GPIO_PIN_RESET);
	}
	else if (driver == TRINAMIC_MOT1_ID)
	{
		HAL_GPIO_WritePin(DRV2_EN_Port, DRV2_EN_Pin, GPIO_PIN_RESET);
